...
INITIAL_SCAFFOLD_PROMPT = (
    ...
    "After exploring, re-examine the original user prompt. If the prompt implies further modifications (e.g., 'Make a hello world app' implies changing the page content), proceed with those modifications. Do not stop and ask the user what to do next if the original prompt contains more instructions.\n\n"
